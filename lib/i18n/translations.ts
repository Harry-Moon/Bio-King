...
export const translations = {
  en: {
    ...
    dashboard: {
      ...
      topAgingFactorsDesc: 'These systems are aging faster than your chronological age',
      ...
      reportNotFoundDesc: "You haven't uploaded any SystemAge report yet. Start by uploading your first report to see your complete analysis.",
  ...
  fr: {
    ...
    dashboard: {
      ...
      topAgingFactorsDesc: 'Ces systèmes vieillissent plus rapidement que votre âge chronologique',
      ...
      reportNotFoundDesc: "Vous n'avez pas encore uploadé de rapport SystemAge. Commencez par uploader votre premier rapport pour voir votre analyse complète.",
